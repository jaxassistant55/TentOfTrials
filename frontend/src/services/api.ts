...
// Base URL for API requests is now managed by apiConfig.ts
// which requires explicit configuration in production and uses
// an intentional development default.
